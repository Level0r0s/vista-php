...
class runtime_process_Process extends runtime_functions_StdFunctions {
	...
	public function unknownOpcode($opCode) {
		haxe_Log::trace("unknownOpcode(" . _hx_string_rec($opCode, "") . ")", _hx_anonymous(array("fileName" => "Process.hx", "lineNumber" => 88, "className" => "runtime.process.Process", "methodName" => "unknownOpcode", "customParams" => (new _hx_array(array($this->bytecodes))))));
	}
