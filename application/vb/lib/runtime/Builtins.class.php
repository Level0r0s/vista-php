...
class runtime_Builtins extends runtime_ProcessBase {
	...
	public function getGlobalName($name) {
		return runtime_SystemDictionary::$instance->get($name);
	}
	public function getObjectName($name) {
		$val = $this->getGlobalName($name);
		if(Std::is($val, _hx_qtype("runtime.objects.QkObject"))) {
			return $val;
		} else {
			return null;
		}
	...
	public function setGlobalName($name, $val) {
		runtime_SystemDictionary::$instance->set($name, $val);
		return $val;
	}
	...
	function __toString() { return 'runtime.Builtins'; }
}
